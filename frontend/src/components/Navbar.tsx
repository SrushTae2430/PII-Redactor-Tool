    ...
    <header className="bg-navy-900 text-white border-b border-navy-800 sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 cursor-pointer" onClick={() => window.location.reload()}>
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="font-extrabold text-xl tracking-tight text-white font-sans">DrishtiKon</span>
              <span className="text-[10px] bg-emerald-500/20 text-emerald-400 font-semibold px-2 py-0.5 rounded border border-emerald-500/30 tracking-wider">
                v2.0 PROD
              </span>
            </div>
            <p className="text-[11px] text-slate-400 font-medium">Intelligent Zero-Retention Redaction Engine</p>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-2 bg-navy-800/80 px-3.5 py-1.5 rounded-full border border-navy-700">
          ...
          <span className="text-xs font-medium text-slate-200">DrishtiKon AI Core Active</span>
